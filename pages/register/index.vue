      ...
      <div class="bg-layer">
        <div class="header-main">
          ...
          <div class="header-left-bottom">
            ...
            <div class="icon1">
              <input id="username" :value="signupData.username" v-trim-input type="text" :placeholder="t('請輸入姓名')"
            ...
            <div class="captchabox">
              ...
              <div class="icon1" style="margin-left: 7px;">
            ...
            <div class="end-btn" style="margin-top: 16px">
              <div class="btn-home" @click="router.push('/')">
                {{ $lang('返回首页') }}
              </div>
              <div class="btn-log" @click="navigateTo('/login')">
                {{ $lang('已有帳號') }}
              </div>
            </div>
          </div>
